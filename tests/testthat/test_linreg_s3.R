suppressWarnings(context("linreg"))
...
# NB: since there is no pred generic, non-explicit calling of pred wouldn't work
# https://www.r-bloggers.com/2018/06/why-your-s3-method-isnt-working
...
# Three escaped backslashes were removed from regex, not sure why they were there in the first place
